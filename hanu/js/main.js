$(document).ready(function() {
  ...
  if (width > 1024) {
    $(".educate-body").addClass("hidden");
    $(".hanu-tuyensinh .card").addClass("hidden");
    $(".hanu-hoatdong .card").addClass("hidden");
    ...
    $(".educate-body").removeClass("hidden");
    $(".hanu-tuyensinh .card").removeClass("hidden");
    $(".hanu-hoatdong .card").removeClass("hidden");
  }
});
